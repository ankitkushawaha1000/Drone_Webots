...
class drone():
    def __init__(self):
        ...
        self.kp_A = [2.0, 2.0, 2.0]
        self.ki_A = [0.1, 0.1, 0.0]
        self.kd_A = [2.0, 2.0, 1.0]
        
        # PID values of position[x, y, z]
        self.kp_P = [0.0, 0.0, 12.0]
        self.ki_P = [0.0, 0.0, 0.05]
        self.kd_P = [0.0, 0.0, 14.0]


    def set_drone(self, robot):
    ...
    def read_sensors(self):
        # Read the sensors:
        self.current_angle[0] = self.imu.getRollPitchYaw()[0] + PI / 2.0
        self.current_angle[1] = self.imu.getRollPitchYaw()[1]
        self.current_angle[2] = self.compass.getValues()[0] - 1
    ...
    def PID_loop(self):
        ...
        for i in range(3):
            self.position_error[i] = self.current_location[i] - self.setpoint_location[i]
        ...
        self.setpoint_angle = [output2, output1, 0]
        ...
        M0 = 70 + throttle - roll - pitch + yaw
        M1 = 70 + throttle + roll - pitch - yaw
        M2 = 70 + throttle - roll + pitch - yaw
        M3 = 70 + throttle + roll + pitch + yaw
